...
$(document).ready(function(){if($('.posting').length===0){return;}
if(typeof(pID)!=='undefined'){initFlag(pID);}
var maxWidth=$('section.body').innerWidth();$(window).resize(function(){if((window.innerWidth<maxWidth)&&(window.innerWidth>0)){$('#postingbody').css('width',window.innerWidth-16);$('aside.tsb').css('width',window.innerWidth-32);}}).resize();var format=CL.cookies.getItem('cl_fmt')||'none';if(typeof(bestOf)!=='undefined'&&!bestOf&&typeof(isPreview)!=='undefined'&&!isPreview&&format!=='mobile'&&format!=='tablet'&&$('.reply_button').length>0){$('.returnemail,.reply_button,.replytext').toggle();$('.reply_button').click(function(){if($('.reply_options').length){$('.returnemail').toggle();}else{$('.returnemail').load('/reply?v=2','',function(){$('.reply_options a, html').click(function(){$('.returnemail').hide();});$('.reply_options,.reply_button').click(function(e){e.stopPropagation();});$('.reply_options').each(function(){var $this=$(this);var c=$this.html()
